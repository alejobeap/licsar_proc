...
## Solve the problem when the tiome is after 23:30 to take the same day not the next date
...
tropo_icams_date.py $new_date --region " "$wesn" " --imaging-time $ttime --dem-tif $hgt --resolution $resol
